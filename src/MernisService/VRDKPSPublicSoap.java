...
public class VRDKPSPublicSoap
{
    ...
    public VRDKPSPublicSoap(){}

    public VRDKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public VRDKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        VRDExtendedSoapSerializationEnvelope envelope= new VRDExtendedSoapSerializationEnvelope(VRDExtendedSoapSerializationEnvelope.VER11);
