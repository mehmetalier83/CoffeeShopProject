...
public class BJJKPSPublicSoap
{
    ...
    public BJJKPSPublicSoap(){}

    public BJJKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public BJJKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        BJJExtendedSoapSerializationEnvelope envelope= new BJJExtendedSoapSerializationEnvelope(BJJExtendedSoapSerializationEnvelope.VER11);
