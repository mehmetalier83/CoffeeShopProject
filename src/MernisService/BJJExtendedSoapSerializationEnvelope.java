...
public class BJJExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(BJJDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new BJJStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static BJJDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static BJJDateTimeConverter dateTimeConverter = new BJJStandardDateTimeConverter();

    public BJJExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public BJJExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new BJJMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=BJJHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,BJJExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=BJJHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
